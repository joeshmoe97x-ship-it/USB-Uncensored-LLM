#!/usr/bin/env bash
# ----------------------------------------------------------------------------
# Provenance: introduced by `3a52e32` (`chore(infra): persist capture-v6.sh + scrub_and_build.py + audit_script.sh + supabase config`, audit-chain adoption v2.1).
...
# Disambiguation: Linux-portable USB wrapper; hardcoded $HOME/USB-Uncensored-LLM/Linux/app project root (line 14).
