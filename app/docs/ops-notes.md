...
- **Proposed target cycle**: `audit-cycle-v2.4` (single-file extension; mirrors the v2.0 / capture-tsc-baseline cadence; promoted from v2.2 after the v2.3 cycle preempted the schedule by adopting 3 file-shells in one commit).
