...

{
  ...
  #   - current valid count: 1 (the L1106 emission-surfaces preservation contract in app/docs/ops-notes.md,
  ...
  #   - v3.0.1 hotfix: regex expanded to support 1 level of nested brackets, resolving the prior L1104
  #     false-positive. The original v3.0 regex `\[audit-note[^]]*\]` truncated at the first `]`, which
  #     misclassified the L1104 marker `[audit-note: [releases-install-snippet-bug] -- RESOLVED]` as
