...

{
  ...
  inv_max=17  # post-v2.9 bump (the v2.9 incident-retro row added at dabda2c, documented in audit-note #3 of d75d527); bump to 18 when a v2.10 row lands
  ...
  # count drift (not just regex-pitfall delta drift). The valid range is [16, 17]:
  ...
  #   - future addition regression (count > 17): a v2.10+ row was added without updating the sentinel
