...

{
  ...
  inv_max=18  # post-v3.0.1 hotfix bump (the new 18th row registers the audit-note nested-brackets regex hotfix inventory entry appended at THIS COMMIT; see the new ### Adopted: audit-note nested-brackets regex hotfix (v3.0.1) H3 under ## Future audit-batch roadmap); bump to 19 when a future v2.x row lands
...
# count drift (not just regex-pitfall delta drift). The valid range is [16, 18]:
