...

{
  ...
  #   - v3.0.1 hotfix: regex expanded to support 1 level of nested brackets, resolving the prior #adopted-bundle-side-integrity-cluster-smoke-test-incident-retro-releases-install-snippet-bug (row 17)
